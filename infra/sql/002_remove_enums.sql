...
-- =============================================================
-- Primero: eliminar defaults que usan enums
-- =============================================================

ALTER TABLE customers         ALTER COLUMN origin       DROP DEFAULT;
ALTER TABLE travels           ALTER COLUMN status       DROP DEFAULT;
ALTER TABLE travel_packages   ALTER COLUMN currency     DROP DEFAULT;
