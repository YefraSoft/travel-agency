...
-- Ejecutar despues de 003_schema.sql
-- =============================================================
...
VALUES
    ('Admin Principal',  'admin@travelagency.com',  '$2a$12$PLACEHOLDER_ADMIN_HASH',  'ADMIN'),
    ('Agente Ventas',    'agente@travelagency.com',  '$2a$12$PLACEHOLDER_AGENT_HASH',  'AGENT'),
    ('Vendedor Uno',     'seller@travelagency.com',  '$2a$12$PLACEHOLDER_SELLER_HASH', 'SELLER');
