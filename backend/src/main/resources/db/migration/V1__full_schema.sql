...
-- Motor: PostgreSQL 16
-- Flyway: V1__full_schema.sql
-- =============================================================
-- Las columnas que antes usaban enums nativos ahora son VARCHAR.
-- La validacion se mantiene en el backend (Kotlin enums + converters).
-- =============================================================

-- =============================================================
-- FUNCTION: updated_at automatico
-- =============================================================
...
CREATE INDEX idx_bookings_pay_limit ON bookings(pay_limit) WHERE status = 'CONFIRMED';
